...
<nav class="container h-auto px-2 mx-auto border-b">
    ...
    <div class="flex flex-row justify-between h-8 my-2">
        ...
        <div class="flex items-center">
            ...
            <button type="submit" wire:loading.attr="disabled" class="px-3 font-sans text-sm text-white border border-solid border-caixaLaranja bg-caixaLaranja bg-opacity-90 h-3/4 hover:bg-opacity-100 focus:outline-none" ><i class="fas fa-save md:mr-2"></i><div class="hidden md:inline-block">Gravar</div></button>
        </div>
    </div>
</nav>
